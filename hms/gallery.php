<?php include('header.php');?>
    <div class="container" id='nav-below-nody'>
        <div class="row" style="padding: 10px;margin: 0%;">
            ...
            <div class="col-sm-4">
            <h3 style="font-family: fantasy;">Hostel</h3>
                ...
                <div class="col-sm-4">
                    <h3 style="font-family: fantasy;">Gym</h3>
                        ...
                        <div class="col-sm-4">
                            <h3 style="font-family: fantasy;">SportsComplex</h3>
    ...
    <div class="row" style="padding: 10px;margin: 0%;">
        <div class="col-sm-4">
        <h3 style="font-family: fantasy;">Dining Hall</h3>
            ...
            <div class="col-sm-4">
                <h3 style="font-family: fantasy;">Canteen</h3>
                    ...
                    <div class="col-sm-4">
                        <h3 style="font-family: fantasy;">Hospital</h3>
